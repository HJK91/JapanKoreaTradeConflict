...
display(solution.pi(2,3,[4 5]));  % share of calibrated model  % share of calibrated model
...
display(solution.pi(2,3,[4 5]));  % share of calibrated model
...
display(real_wage_hat_CD-1)
display(real_wage_hat./real_wage_hat_CD-1)
